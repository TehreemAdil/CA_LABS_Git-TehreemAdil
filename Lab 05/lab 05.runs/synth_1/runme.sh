...
HD_PWD='C:/Users/ta11696/lab 05/lab 05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fsm_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_fsm_system.tcl
