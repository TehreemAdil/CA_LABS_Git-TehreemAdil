...
HD_PWD='C:/Users/ta11696/lab 05/lab 05.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fsm_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_fsm_system.tcl -notrace
